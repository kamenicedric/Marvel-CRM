...
const WorkflowConfigModule: React.FC = () => {
  ...
  const [workflows, setWorkflows] = useState<Record<string, DetailedTaskTemplate[]>>(FORMULA_WORKFLOWS);
        ...
        <div className="flex-1 overflow-y-auto bg-[#F8FAFC] p-10 relative no-scrollbar">
          <div className="max-w-5xl mx-auto space-y-10 pb-32">
             <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                ...
                <button className="px-10 py-5 bg-[#006344] text-white rounded-2xl font-black text-[11px] uppercase tracking-widest shadow-2xl shadow-[#006344]/30 flex items-center gap-3 hover:scale-105 transition-all">
