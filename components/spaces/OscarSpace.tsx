      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
         ...
         <div className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-slate-100 flex items-center gap-6">
            ...
            <div>
               ...
               <h3 className="text-4xl font-black text-[#006344] italic tracking-tighter">98%</h3>
            </div>
         </div>
         <div className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-slate-100 flex items-center gap-6">
            ...
            <div>
               ...
               <h3 className="text-3xl font-black text-slate-900 italic tracking-tighter">120.000 F</h3>
            </div>
         </div>
         <div className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-slate-100 flex items-center gap-6">
